...
public class AnswerServiceImpl implements AnswerService {
    ...
    private AnswerResponse convertToResponse(AnswerEntity answerEntity) {
        Long upvotes = questionUpVoteRepository.countAllByQuestionId(answerEntity.getId());
        Long downvotes = questionDownVoteRepository.countAllByQuestionId(answerEntity.getId());
